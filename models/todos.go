...
type Todo struct {
	...
	TodoLabel  string    `boil:"todo_label" json:"todo_label" toml:"todo_label" yaml:"todo_label"`
	TodoStatus null.Int  `boil:"todo_status" json:"todo_status,omitempty" toml:"todo_status" yaml:"todo_status,omitempty"`
...
var TodoTableColumns = struct {
	...
	ID:         "todos.id",
	TodoLabel:  "todos.todo_label",
	TodoStatus: "todos.todo_status",
...
var TodoWhere = struct {
	ID         whereHelperuint
	TodoLabel  whereHelperstring
	TodoStatus whereHelpernull_Int
	CreatedAt  whereHelpertime_Time
	UpdatedAt  whereHelpertime_Time
}{
	ID:         whereHelperuint{field: "`todos`.`id`"},
	TodoLabel:  whereHelperstring{field: "`todos`.`todo_label`"},
	TodoStatus: whereHelpernull_Int{field: "`todos`.`todo_status`"},
...
var (
	todoAllColumns            = []string{"id", "todo_label", "todo_status", "created_at", "updated_at"}
	todoColumnsWithoutDefault = []string{"todo_label", "todo_status"}
